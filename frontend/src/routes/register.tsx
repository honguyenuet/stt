...
function RegisterPage() {
  ...
  const oauthErrors: Record<string, string> = {
    ...
    google_email_exists:
      "Thư điện tử này đã có tài khoản Vbee. Hãy đăng nhập bằng phương thức đã dùng trước đó.",
    ...
    facebook_email_exists:
      "Thư điện tử Facebook đã có tài khoản Vbee. Hãy đăng nhập bằng phương thức đã dùng trước đó.",
    ...
    apple_email_exists:
      "Thư điện tử Apple đã có tài khoản Vbee. Hãy đăng nhập bằng phương thức đã dùng trước đó.",
      ...
      <div className="relative z-10 grid w-full max-w-5xl items-center gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <h1 className="text-2xl font-black leading-tight text-foreground md:text-3xl">
            Bắt đầu hành trình{" "}
            <span className="mt-1 block text-[#21104a]">cùng Vbee!</span>
          </h1>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="ml-auto flex items-end gap-[3px] h-5">
                {[0.6, 1, 0.7, 0.9, 0.5, 0.8, 0.6].map((_, i) => (
                  <span
                    key={i}
                    className="w-[3px] rounded-full bg-primary/60 animate-wave"
          ...
          <Link
            to="/"
            className="mt-6 text-sm text-muted-foreground hover:text-foreground transition hidden lg:inline-flex items-center gap-1"
          >
            ← Quay về trang chủ
          </Link>
        </div>
          ...
          <div className="rounded-lg border border-border bg-white p-5 shadow-soft md:p-6">
            ...
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Đăng ký bằng thư điện tử và mật khẩu an toàn
              </p>
            </div>

            {ref && (
              <div className="mb-5 rounded-xl border border-[#f0d66a] bg-[#fff9d7] px-4 py-3 text-sm text-[#4a356e]">
                Bạn đang đăng ký bằng mã giới thiệu <strong>{ref}</strong>.
                Người mời sẽ nhận 100 phút sau văn bản đầu tiên của bạn.
              </div>
            )}
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <div className="flex items-end gap-[3px] px-1">
                {[0.5, 0.9, 0.6, 1, 0.7, 0.8, 0.5].map((_, i) => (
                  <span
                    key={i}
                    className="w-[3px] h-3 rounded-full bg-primary/40 animate-wave"
